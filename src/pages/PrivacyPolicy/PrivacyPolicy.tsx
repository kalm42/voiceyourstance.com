      ...
      <div>
        <div>
          <div>
            ...
            <p>
              <strong>Last updated May 30, 2020</strong>
            </p>
          </div>
        </div>
        <div>
          <div>
            <p>
              Thank you for choosing to be part of our community at Voice Your Stance (&ldquo;<strong>Company</strong>
              &rdquo;, &ldquo;<strong>we</strong>&rdquo;, &ldquo;<strong>us</strong>&rdquo;, or &ldquo;
              <strong>our</strong>&rdquo;). We are committed to protecting your personal information and your right to
              privacy. If you have any questions or concerns about our policy, or our practices with regards to your
              personal information, please contact us at admin@voiceyourstance.com.
            </p>
            <p>
            ...
            <p>
              ...
              collectively in this privacy policy as the "<strong>Sites</strong>").
            </p>
            <p>
              <strong>
            ...
            <p>
              ...
              associated with your payment instrument. All payment data is stored by our payment processor and you
              should review its privacy policies and contact the payment processor directly to respond to your
              questions.{" "}
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                ...
                (see the " <a href="privacy-policy/#privacyrights">WHAT ARE YOUR PRIVACY RIGHTS</a> " below). <br />
                <br />
              </li>
              <li>
              ...
              <li>
                ...
                your orders, payments, returns, and exchanges made through the Sites.{" "}
              </li>
            </ul>
            <p id="infoshare">
            ...
            <ul>
              <li>
                ...
                may allow selected third parties to use tracking technology on the Sites, which will enable them to
                collect data about how you interact with the Sites over time. This information may be used to, among
                ...
                information with third parties for their promotional purposes. <br />
                <br />
              </li>
              <li>
