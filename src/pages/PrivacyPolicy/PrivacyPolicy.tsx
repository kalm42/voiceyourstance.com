    ...
    <Section id="privacy">
      ...
      <div>
        <p>
          ...
          <em>our</em>&rdquo;). We are committed to protecting your personal information and your right to privacy. If
        ...
        <p>
          This privacy policy applies to all information collected through our website (such as voiceyourstance.com),
        ...
        <p>
          ...
          <em>
            We collect personal information that you provide to us such as name, address, contact information, passwords
            and security data, and payment information.
          </em>{" "}
        </p>
        <p>
          We collect personal information that you voluntarily provide to us when registering at the Sites expressing an
        ...
        <p>
          The personal information that we collect depends on the context of your interactions with us and the Sites,
        ...
        <p>
          <em>Payment Data.</em>&nbsp;We collect data necessary to process your payment if you make purchases, such as
        ...
        <p>
          ...
          <em>
            Some information &ndash; such as IP address and/or browser and device characteristics &ndash; is collected
        ...
        <ul>
          <li>
            <em>To facilitate account creation and logon process.</em>&nbsp;If you choose to link your account with us
            to a third party account *(such as your Google or Facebook account), we use the information you allowed us
            to collect from those third parties to facilitate account creation and logon process. <br />
            <br />
          </li>
          <li>
          ...
          <li>
            <em>To send administrative information to you.&nbsp;</em>We may use your personal information to send you
            product, service and new feature information and/or information about changes to our terms, conditions, and
            policies. <br />
            <br />
          </li>
          <li>
            <em>Fulfill and manage your orders.</em>&nbsp;We may use your information to fulfill and manage your orders,
        ...
        <ul>
          ...
          <li>
            <em>Performance of a Contract:&nbsp;</em>Where we have entered into a contract with you, we may process your
            personal information to fulfill the terms of our contract.
            <br />
            <br />
          </li>
          <li>
            <em>Legal Obligations:</em> We may disclose your information where we are legally required to do so in order
          ...
          <li>
            <em>Vital Interests:</em> We may disclose your information where we believe it is necessary to investigate,
        ...
        <ul>
          <li>
            ...
            parties to use tracking technology on the Sites, which will enable them to collect data about how you
            interact with the Sites over time. This information may be used to, among other things, analyze and track
          ...
          <li>
            <em>Business Transfers.</em>&nbsp;We may share or transfer your information in connection with, or during
        ...
        <p>
          ...
          minor dependent&rsquo;s use of the Sites. If we learn that personal information from users less than 18 years
          ...
          contact us at admin@voiceyourstance.com.{" "}
        </p>
        <p id="privacyrights">
        ...
        <p>
          ...
          affect certain features or services of our Sites. To opt-out of interest-based advertising by advertisers on
          our Sites visit <a href="http://www.aboutads.info/choices/">http://www.aboutads.info/choices/</a>.{" "}
        </p>
        <p>
          <em>
          ...
          marketing email list &ndash; however, we will still need to send you service-related emails that are necessary
          for the administration and use of your account. To otherwise opt-out, you may:{" "}
        </p>
        ...
        <p>
          ...
          about your online browsing activities monitored and collected. No uniform technology standard for recognizing
          and implementing DNT signals has been finalized. As such, we do not currently respond to DNT browser signals
          or any other mechanism that automatically communicates your choice not to be tracked online. If a standard for
        ...
        <p>
          If you are under 18 years of age, reside in California, and have a registered account with the Sites, you have
          the right to request removal of unwanted data that you publicly post on the Sites. To request removal of such
          ...
          displayed on the Sites, but please be aware that the data may not be completely or comprehensively removed
          from our systems.
        </p>
        <p id="policyupdates">
